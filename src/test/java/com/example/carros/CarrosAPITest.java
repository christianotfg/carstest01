...
public class CarrosAPITest {
	...
	private ResponseEntity<CarroDTO> getCarro(String url) {
		return rest.withBasicAuth("user01", "123").getForEntity(url, CarroDTO.class);
	}
	
	private ResponseEntity<List<CarroDTO>> getCarros(String url) {
		return rest.withBasicAuth("user01", "123").exchange(url, HttpMethod.GET, null, new ParameterizedTypeReference<List<CarroDTO>>() {} );
	}
	...
	public void testSave() {
		...
		//Insert
		ResponseEntity response = rest.withBasicAuth("user01", "123").postForEntity("/api/v1/carros", carro, null);
		...
		//Deletar o objeto
		rest.withBasicAuth("user01", "123").delete(location);
